...
\begin{frame}
    ...
    \begin{enumerate}\addtocounter{enumi}{-1}
        ...
        \end{itemize}
        \item Version \texttt{0.05e} introduced a new option \texttt{condendsedmetaot}
        \begin{itemize}
...
\begin{frame}
    ...
    \footnotetext[3]<3->{See this frame for reference; only when all contents are displayed, the frame counter turns orange}
    \footnotetext[4]<3->{See this presentation for reference; only for frames with multiple pages, the frame counter turns orange}
\end{frame}
